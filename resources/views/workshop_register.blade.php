        ...
        <div class="col-md-8 col-md-offset-2">
            {{-- <div class="panel panel-default"> --}}
                ...
                <div class="panel-body">
                    <h1 id="heading" style="color:black;">Create Your <b style="color:#8C001A">WORKSHOP</b></h1>
                <form class="form-horizontal" method="POST"  action="{{URL::to('/workshop')}}">
                        {{ csrf_field() }}
                    @if(!isset($errorM))
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            <label for="title" class="col-md-4 control-label" style="color:black;">Title:</label>
                        ...
                        <div class="form-group{{ $errors->has('nb_of_users') ? ' has-error' : '' }}">
                            <label for="nb_of_users" class="col-md-4 control-label" style="color:black;">Number of Users:</label>
                        ...
                        <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                            <label for="description" class="col-md-4 control-label" style="color:black;">Description:</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4" id="button">
