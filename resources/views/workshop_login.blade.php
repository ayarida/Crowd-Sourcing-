    ...
    <div style="margin-top: 15%" class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="color:#8C001A;text-align:center"><b>Login to Workshop</b></div>
                ...
                <div class="panel-body">
                    <form  class="form-horizontal" method="POST" action="{{ URL::to('/workshop/join_workshop') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="key" class="col-md-4 control-label" style="color:black">Workshop Key</label>
