...
{{ csrf_field() }}
<tr><th>user_id</th><th>user_name</th><th>user_Email</th><th>Idea</th></tr>
...
<td>{{$value->idea}}</td>
<td>{{$value->grade}}</td>
<td><button type="submit" name='idea' value={{$value->id}}>Click Me!</button></td>
<td><input type="hidden" name="workshop_key" value={{$value->workshop_key}}/></td>
</tr>
